...
<div style="display: flex; justify-content: space-between;">
    <img src="./src/assets/readmeMedidores/coordenadasMobile1.png" heigth="100%" width="50%">
    <img src="./src/assets/readmeMedidores/coordenadasMobile2.png" heigth="100%" width="50%">
</div>
